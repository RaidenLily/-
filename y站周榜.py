...
url = "https://yande.re/post/popular_by_week"
head = {}
...
def crawl_parse(a_url):
    soup2 = BeautifulSoup(requests.get('https://yande.re'+a_url,headers=head).text, features='lxml')
    ...
    with open(r'C:\Users\Saber\Desktop\y站周榜\%s' %image_name, 'wb') as f:
